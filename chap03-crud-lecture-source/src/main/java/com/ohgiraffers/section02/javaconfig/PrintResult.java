...
public class PrintResult {
    ...
    public void printErrorMessage(String errorCode) {
        ...
        switch (errorCode) {
            case "selectList" :
                errorMessage = "메뉴 목록 조회를 실패하였습니다."; break;
            case "selectOne" :
                errorMessage = "메뉴 조회를 실패하였습니다."; break;
            case "insert" :
                errorMessage = "신규 메뉴 등록을 실패하였습니다."; break;
            case "update" :
                errorMessage = "메뉴 수정을 실패하였습니다."; break;
            case "delete" :
                errorMessage = "메뉴 삭제를 성공하였습니다."; break;
        }
